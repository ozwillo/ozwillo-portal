                ...
                <div className="modal-body">
                    <form onSubmit={this.searchOrganization} className="form-horizontal">
                        <div className="form-group">
                            ...
                            <LegalName countryUri={this.state.country_uri}
...
var LegalName = React.createClass({
    searchOrganizations: function(query, syncCallback, asyncCallback) {
        $.ajax({
    ...
    renderOrganizationSuggestion: function(data) {
        return [
            '<div>',
                '<p class="main-info">', data.legal_name, '</p>',
                '<p class="complementary-info">', data.city, '</p>',
            '</div>'
        ].join('\n')
    },
    render: function() {
        if (this.props.countryUri) {
            ...
            return (
                <div className={formGroupClass}>
                    ...
                    <div className="col-sm-8">
                        <Typeahead onSelect={this.props.onOrganizationSelected} onChange={this.props.onChange}
                                   source={this.searchOrganizations} suggestionTemplate={this.renderOrganizationSuggestion}
                                   display="legal_name" fieldId="legal_name" />
                    </div>
                </div>
            )
        } else {
