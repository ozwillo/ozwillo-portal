var converter = new Showdown.converter({extensions: ["table"]}), AppStore = React.createClass({
    ...
    updateApps: function (target_citizens, target_publicbodies, target_companies, paid, free) {
        $.ajax({
            ...
            success: function (data) {
                this.setState({apps: data, loading: !1})
            }.bind(this),
    ...
    render: function () {
        return this.state.loading ? React.DOM.div({className: "row text-center"}, React.DOM.i({className: "fa fa-spinner fa-spin"}), " ", t("ui.loading")) : React.DOM.div({className: "row"}, SideBar({updateApps: this.updateApps}), AppList({apps: this.state.apps}))
    }
