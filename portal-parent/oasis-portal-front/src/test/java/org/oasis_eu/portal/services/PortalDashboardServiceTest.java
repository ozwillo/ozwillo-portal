...
public class PortalDashboardServiceTest {
    ...
    public void testDashboardService() {
        ...
        mock.expect(requestTo("https://oasis-demo.atolcd.com/n/bb2c6f76-362f-46aa-982c-1fc60d54b8ef/messages?appId=4de8452c-043f-401b-882f-1a489cb22743"))
        ...
        mock.expect(requestTo("https://oasis-demo.atolcd.com/n/bb2c6f76-362f-46aa-982c-1fc60d54b8ef/messages?appId=f5801113-db1e-4d89-afcf-7a1d19555eb3"))
                .andRespond(withSuccess("[]", MediaType.APPLICATION_JSON));
