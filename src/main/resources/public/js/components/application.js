...
export class Indicator extends React.PureComponent {
    render() {
        ...
        if (status === 'installed') {
            btns = [
                <button type="button" key="indicator_button" className="btn btn-lg btn-installed">
            ...
            btns = [
                <button type="button" key="indicator_button" className="btn btn-lg btn-free">
                    {i18n._(t`store.free`)}
                </button>,
            ...
            btns = [
                <button type="button" key="indicator_button" className="btn btn-lg btn-buy">
                    {i18n._(t`store.paid`)}
                </button>,
