    ...
    render: function () {
        ...
        return (
          <div>
            ...
            <Modal ref="modalError" title={this.context.t('ui.something_went_wrong_title')} infobox={true} cancelHandler={null} >
                ...
                <div className="row">
                    ...
                    <div className="col-sm-7">
                        <div>
                            ...
                            <RatingWrapper rating={stateApp.rating} appId={this.props.app.id} rateable={stateApp.rateable} rate={this.props.rateApp}/>
                            {rateInfo}
                        </div>
                    </div>
...
var OrganizationSearchFormControl = createClass({
    renderType: function () {
        ...
        return (
            <div className={formGroupClass}>
                <label htmlFor="organization-sector-type" className="col-sm-3 control-label required">{this.context.t('search.organization.sector-type')} *</label>
                <div className="col-sm-8">
                    {public_body}
                    {company}
                </div>
    ...
    render: function () {
        ...
        switch(this.props.orgSearchData.country){
            case 'България' : label_regNum = this.context.t('search.organization.business-id.bg'); break;
            case 'Italia'   : label_regNum = this.context.t('search.organization.business-id.it'); break;
            case 'France'   : label_regNum = this.context.t('search.organization.business-id.fr'); break;
            case 'España'   : label_regNum = this.context.t('search.organization.business-id.es'); break;
            case 'Türkiye'  : label_regNum = this.context.t('search.organization.business-id.tr'); break;
            default         : label_regNum = this.context.t('search.organization.business-id.en'); break;
        }
