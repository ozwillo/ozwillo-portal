...
import { RatingWrapper } from './rating.jsx';
import { GeoAreaAutosuggest } from '../util/geoarea-autosuggest.jsx';
import { CreateOrModifyOrganizationForm} from '../network/create-or-modify-organization.jsx';
                     ...
                     : (<div className='radio col-sm-offset-3 col-sm-8'>
                            <label>
                                <input type="radio" value="PERSONAL" checked={installType == 'PERSONAL'}
                                     onChange={this.toggleType} />{t('install.org.type.PERSONAL')}
                            </label>
                        </div>
                       );
                ...
                : (<div className='radio col-sm-offset-3 col-sm-8'>
                        <label>
                            <input type="radio" value="ORG" checked={installType == 'ORG'}
                                onChange={this.toggleType} />{t('install.org.type.ORG')}
                        </label>
                   </div>
                  );
            ...
            public_body = (
                <label className="radio-inline col-sm-3">
                    <input type="radio" value="PUBLIC_BODY" checked={this.props.orgSearchData.sector_type == 'PUBLIC_BODY'}
                           onChange={this.props.toggleType} />{t('search.organization.sector-type.PUBLIC_BODY')}
                </label>
            );
        }
            ...
            company = (
                <label className="radio-inline col-sm-3">
                    <input type="radio" value="COMPANY" checked={this.props.orgSearchData.sector_type  == 'COMPANY'}
                           onChange={this.props.toggleType} />{t('search.organization.sector-type.COMPANY')}
                </label>
            );
        }
