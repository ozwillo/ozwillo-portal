...
var ServiceSettings = React.createClass({
    ...
    getGeoAreInitialValue: function() {
        if (!this.props.service.service.geographical_areas || this.props.service.service.geographical_areas.length === 0)
            return ''
        else {
            const decodedGeoArea = decodeURIComponent(this.props.service.service.geographical_areas[0]);
