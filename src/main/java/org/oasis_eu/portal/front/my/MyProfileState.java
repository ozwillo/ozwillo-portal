...
public class MyProfileState {
    ...
    public void reset() {
        ...
        adFormLayout.appendWidget(new FormWidgetAutocomplete("address.country", "my.profile.personal.country"));
        adFormLayout.appendWidget(new FormWidgetAutocomplete("address.locality", "my.profile.personal.locality"));
